...
public class Home {
	...
	//these are the options that will be available on the home page ---->
	public void homeView(int id) throws SQLException {
		...
		//adding mouse listeners on the labels ,such that on clicking over the labels their  respective page will be opened----> 
